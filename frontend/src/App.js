...
function App() {
  ...
  return (
    <div className="min-h-screen">
      <header className="bg-gradient-to-r from-[#00D4FF] to-[#00F2C9] shadow-lg">
        <div className="container mx-auto px-4 py-8">
          <h1 className="text-4xl md:text-5xl font-bold text-black text-center">
            Recomendador de Produtos
          </h1>
          <p className="text-black text-center mt-2 text-lg">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-gray-200">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 leading-relaxed max-w-4xl mx-auto">
