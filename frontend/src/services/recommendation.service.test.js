...
describe('recommendationService', () => {
  describe('Casos básicos de funcionalidade', () => {
  ...
  describe('Lógica de scoring e ordenação', () => {
  ...
  describe('Tratamento de empates', () => {
    test('Em caso de empate, retorna o último produto (ordem original)', () => {
  ...
  describe('Integração com produtos reais', () => {
